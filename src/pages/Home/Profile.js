...
const ProfileText = ({ status, titleId }) => (
    <Fragment>
        ...
        <Text
            ...
            size="l"
        >
        my name is Prathamesh Shinde! I recently completed my Diploma in Computer Engineering, and now I am pursuing a Bachelor of Engineering degree. I am passionate about all things tech, and I love to stay up to date on the latest developments in the industry. In fact, I am a lead member of my college's coding club, where we explore different programming languages and tackle challenging projects together.{' '}
