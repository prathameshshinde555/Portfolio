...
const disciplines = ['Student', 'Coder']
...
const Home = () => {
    ...
    return (
        <div className="home">
            <Helmet>
                <title>Prathamesh Shinde | Devloper + </title>
                <meta
                    name="description"
                    content="Portfolio of Prathamesh Shinde – a backend devloper working on node apps"
                />
            ...
            <ProjectSummary
                ...
                index={1}
                title="MegaJob Fair"
                description="A website for a job-fair."
                buttonText="View Project"
                buttonLink="https://prathameshshinde555.github.io/MegaJob-Fair/"
                model={{
                    type: 'laptop',
                    alt: 'Ethereal',
                    textures: [
            ...
            <ProjectSummary
                ...
                index={2}
                title="MyGallery"
                description="Android App to set cool wallpaper"
                buttonText="View Project"
                buttonLink="https://github.com/prathameshshinde555/MyGallery"
                model={{
                    type: 'phone',
                    alt: 'Weebify',
                    textures: [
            ...
            <ProjectSummary
                ...
                index={3}
                title="G-Store"
                description="A e-commerce website for anime"
                buttonText="View Project"
                buttonLink="https://prathameshshinde555.github.io/G-Store-/"
                model={{
                    type: 'laptop',
            ...
            <ProjectSummary
                ...
                index={4}
                title="Gesture Hand Controller"
                description="Control your computer using hand signs"
                buttonText="View Project"
                buttonLink="https://github.com/prathameshshinde555/Gesture_Hand_Controller"
                model={{
                    type: 'phone',
                    alt: 'Void',
                    textures: [
